    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, auth_services_1.registerUser)(name_1, email, password)];
            case 1:
                user = _b.sent();
...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, authResponse, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, email = _a.email, password = _a.password;
                return [4 /*yield*/, (0, auth_services_1.authenticateUser)(email, password)];
            case 1:
